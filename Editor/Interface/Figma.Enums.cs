...
{
    public enum EffectType { INNER_SHADOW, DROP_SHADOW, LAYER_BLUR, BACKGROUND_BLUR, GLASS, TEXTURE }
    ...
    public enum PaintType { SOLID, GRADIENT_LINEAR, GRADIENT_RADIAL, GRADIENT_ANGULAR, GRADIENT_DIAMOND, IMAGE, EMOJI, VIDEO }
    ...
    public enum NodeType { DOCUMENT, CANVAS, SLICE, FRAME, GROUP, COMPONENT_SET, COMPONENT, INSTANCE, BOOLEAN_OPERATION, VECTOR, STAR, LINE, ELLIPSE, REGULAR_POLYGON, RECTANGLE, TEXT, SECTION, TABLE, TABLE_CELL, WASHI_TAPE, STICKY, SHAPE_WITH_TEXT, CONNECTOR, CODE_BLOCK, WIDGET, EMBED, LINK_UNFURL, MEDIA }
